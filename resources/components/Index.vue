            ...
            <div class="headerwrapper">
                <div class="header-left">
                    <a href="index.html" class="logo">
                        <img  src="" alt="" />  <!-- src="images/logo.png" -->
                    </a>
                        ...
                        <div class="btn-group btn-group-list btn-group-notification">
                            ...
                            <div class="dropdown-menu pull-right">
                                ...
                                <ul class="media-list dropdown-list">
                                    <li class="media">
                                         <img class="img-circle pull-left noti-thumb" src="" alt="">  <!--  src="images/photos/user1.png" -->
                                    ...
                                    <li class="media">
                                        <img class="img-circle pull-left noti-thumb" src="" alt="">   <!-- src="images/photos/user2.png" -->
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                         <img class="img-circle pull-left noti-thumb" src="" alt=""> <!-- src="images/photos/user3.png" -->
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                         <img class="img-circle pull-left noti-thumb" src="" alt=""> <!--src="images/photos/user4.png" -->
                                        <div class="media-body">
